...
async function main() {
    ...
    const PORT = await getVariableValue('PORT', '56000');// 建议10000-65000之间随便取个数字，比如报503错误，请尝试更换端口,为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
